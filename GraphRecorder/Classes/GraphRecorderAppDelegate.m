...
#import "GraphRecorderAppDelegate.h"
#import "GraphRecorderViewController.h"

@implementation GraphRecorderAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	NSString *filePath = [[NSBundle mainBundle] pathForResource:@"808 loop" ofType:@"wav"];
	...
	//load the audio file
	audioManager->inMemoryAudiofile->loadFile(audioFileURL);
	
	[viewController setAudioManager:audioManager];
